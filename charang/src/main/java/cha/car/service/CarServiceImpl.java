...
public class CarServiceImpl implements CarService {
   ...
   public List<CarDTO> getAllCarPage(int startRow, int pageSize, String sortType, String sort) {
      ...
      return carmapper.AllCarPage(startRow, pageSize, sortType, sort);
   }
   ...
   // 검색 차량 출력
   @Override
   public List<CarDTO> getSearchCar(int startRow, int pageSize, String searchType, String searchKeyWord, String sortType, String sort) {
      System.out.println("차 서비스 : 검색 차량 출력 서비스");
      return carmapper.getSearchCar(startRow, pageSize, searchType, searchKeyWord, sortType, sort);
   }
