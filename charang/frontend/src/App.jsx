...
import CustomerServiceInquiry from './pages/CustomerServiceInquiry';
import CustomerServiceFAQ from './pages/CustomerServiceFAQ';
import CustomerServiceNotice from './pages/CustomerServiceNotice';
import CustomerServiceNoticeDetail from './pages/CustomerServiceNoticeDetail';
            ...
            <BrowserRouter>
              ...
              <Routes>
                ...
                <Route path="/customerservice" element={<CustomerService />}>
                    ...
                    <Route path="notice/:id" element={<CustomerServiceNotice/>} />  {/* 공지사항 상세*/}
                </Route>
