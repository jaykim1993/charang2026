        ...
        <>
            <div className="LocationPage3">
                ...
                <ol className="LocationPage3Ol">
                    ...
                    <li className="LocationPage3Li">반납 전 차량 내 쓰레기 및 오염 여부를 간단히 정리해 주세요. 과도한 오염 시 세차 비용이 부과될 수 있어요.</li>
                    <li className="LocationPage3Li">차량 경고등이 점등된 경우 또는 이상이 느껴질 경우, 반납 시 반드시 직원에게 말씀해 주세요.</li>
                    <li className="LocationPage3Li">지정된 반납 장소가 아닌 곳에 임의로 주차할 경우 추가 견인 비용이 발생할 수 있어요.</li>
                </ol>
