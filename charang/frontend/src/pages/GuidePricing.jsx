...
export default function GuidePricing() {
    ...
    const FOREIGN_BRANDS = ['파르세', '아우디즈', '빈츠', 'DMW', '렉사드', '테셀라', '볼바즈', '복스바그', '토유', 'BYZ'];
    ...
    return (
        <div className="guidePricing">
            <h3>요금안내</h3>
            <div className="guidePricing_head">
            ...
            <div className="guideSelectCarSize">
                {selectWhereCar ? (
                    ...
                    <div className="guideSelectForCar">
                        <button className={`guideSelectCarSizeBtn ${selectForeignSize === 1 ? 'active' : ''}`} onClick={selectForeignSmall}>경소형</button>
                        <button className={`guideSelectCarSizeBtn ${selectForeignSize === 2 ? 'active' : ''}`} onClick={selectForeignMiddle}>중형</button>
                        <button className={`guideSelectCarSizeBtn ${selectForeignSize === 3 ? 'active' : ''}`} onClick={selectForeignLarge}>대형</button>
                    </div>
                )}
            </div>
