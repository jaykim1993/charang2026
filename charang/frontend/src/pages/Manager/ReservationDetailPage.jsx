                ...
                <table className="reservationDetail_table">
                    <tbody className="reservationDetail_table_body">
                        <tr className="reservationDetail_tr">
                            <td className="reservationDetail_td">예약코드</td>
                            <th className="reservationDetail_data2" onClick={() => copyText(selectedBooking.bookingId)} title="클릭하면 예약코드가 복사됩니다">{selectedBooking.bookingId}</th>
                        </tr>
                        <tr className="reservationDetail_tr">
                            <td className="reservationDetail_td">예약자ID</td>
                            <th className="reservationDetail_data2"  onClick={() => copyText2(selectedBooking.userId)} title="클릭하면 예약자ID가 복사됩니다">{selectedBooking.userId}</th>
                        </tr>
                        <tr className="reservationDetail_tr">
                        ...
                        <tr className="reservationDetail_tr">
                            <td className="reservationDetail_td">차량ID</td>
                        ...
                        <tr className="reservationDetail_tr">
                            <td className="reservationDetail_td">브랜드 - 모델</td>
                        ...
                        <tr className="reservationDetail_tr">
                            <td className="reservationDetail_td">대여금액</td>
