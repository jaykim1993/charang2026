                ...
                <table className="userMod_table">
                    <tbody className="userMod_table_body">
                        <tr className="userMod_tr">
                            <td className="userMod_td">회원ID</td>
                            <th className="userMod_data2" onClick={() => copyText(oneUser.userId)} title="클릭하면 회원ID가 복사됩니다">{oneUser.userId} </th>
                        </tr>
                        <tr className="userMod_tr">
                            <td className="userMod_td">회원이름</td>
                            <th className="userMod_data2" onClick={() => copyText2(oneUser.name)} title="클릭하면 회원명이 복사됩니다">{oneUser.name} </th>
                        ...
                        <tr className="userMod_tr">
                            ...
                            <th className="userMod_data">{oneUser.license}종 보통</th>
                        </tr>
                        <tr className="userMod_tr">
