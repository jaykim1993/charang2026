...
export default function CarRegPage() {
    const { allCar, allHandler } = useContext(DataContext);
    // 모든 값 하나의 객체로 관리
        ...
        <div className="carRegPage">
            <div className="crp_container">
                <div className="crp_header">
                    <h1>차량 등록</h1>
                    <button type="button" className="crp_listBtn" onClick={() => {allHandler(); navi(-1)}}>전체목록</button>
                </div>
                ...
                <table className="car_reg_table">
                    <tbody className="car_reg_tbody">
                        ...
                        <tr className="crp_tr">
                            ...
                            <td className="crp_data">
                                <input type="number" name="driverMinAge" className="crp_input" placeholder="예) 23"
                                    onChange={inputHandler} />
                            </td>
                        </tr>
                        <tr className="crp_tr">
                        ...
                        <tr className="crp_tr">
                            ...
                            <td className="crp_data">
                                ...
                                className="crp_input" placeholder="예) 1.5"/>
                            </td>
                        </tr>
                        <tr className="crp_tr">
