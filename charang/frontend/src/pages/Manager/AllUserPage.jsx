            ...
            <table className="managerAllUser_table" border={1}>
                ...
                <thead className="managerAllUser_table_th">
                    <tr className="managerAllUser_tr">
                        ...
                        <th onClick={() => sortHandler("userId")} className="managerAllUser_userId">회원ID<i className="bi bi-chevron-down"></i></th>

                        <th onClick={() => sortHandler("name")} className="managerAllUser_userName">회원이름<i className="bi bi-chevron-down"></i></th>

                        <th onClick={() => sortHandler("mail")} className="managerAllUser_userEmail">이메일<i className="bi bi-chevron-down"></i></th>

                        <th onClick={() => sortHandler("resistNum")} className="managerAllUser_userResiNum">주민등록번호<i className="bi bi-chevron-down"></i></th>

                        <th onClick={() => sortHandler("phone")} className="managerAllUser_userPhone">휴대폰번호<i className="bi bi-chevron-down"></i></th>

                        <th onClick={() => sortHandler("regDate")} className="managerAllUser_userRegDate">가입일자<i className="bi bi-chevron-down"></i></th>
